...
const rows = [
  createData('Legaliza', 159, 6.0, Estado.Deudor, 24, 4.0, 3.99),
...
export default function CollapsibleTable() {
  ...
  return (
    <TableContainer component={Paper} sx={{ border: `1px solid ${theme.palette.grey[200]}` }}>
      <Table aria-label="collapsible table">
        <TableHead>
          <TableRow>
            ...
            <TableCell align="right">Nombre de Contacto</TableCell>
            <TableCell align="right">Fecha de Cierre </TableCell>
            <TableCell align="right">Producto</TableCell>
            <TableCell align="right">Estado de Negocio</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {rows.map((row) => (
