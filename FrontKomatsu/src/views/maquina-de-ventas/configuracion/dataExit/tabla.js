...
const initialRows = [
  {
    id: 1,
    perfil: 'Subgerente de Operaciones'
  },
  {
    id: 2,
    perfil: 'Subgerente Comercial'
  },
  {
    id: 3,
  ...
  {
    id: 5,
    perfil: 'Encargado Contabilidad'
  }
];

export default function DataExit() {
  const columns = [
    { field: 'perfil', headerName: 'Perfil', width: 150, editable: true, flex: 2 },
