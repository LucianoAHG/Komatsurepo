...
const dataTabla3 = [
  { id: 9, ciudad: '', poblacion: '48' },
];

const Tabla1 = () => {
  const columns = [
    { field: 'nombre', headerName: 'Productos', width: 300 },
  ];
...
const Tabla2 = () => {
  const columns = [
    { field: 'producto', headerName: 'Participacion', width: 300 },
  ];
...
const Tabla3 = () => {
  const columns = [
    { field: 'ciudad', headerName: 'Socios', width: 300 },
  ];
