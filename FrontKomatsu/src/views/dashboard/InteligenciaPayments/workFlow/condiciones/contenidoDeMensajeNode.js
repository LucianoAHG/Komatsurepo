...
const ConditionContenidoDelMensaje = ({ isConnectable, id, data }) => {
  ...
  //Funcion para guardar id y type en localStorage set.item guarda el dato.
  useEffect(() => {
    if (buttonType) {
  ...
  //FUNCION PARA SACAR DATOS DEL LOCAL STORAGE, USANDO getItem
  useEffect(() => {
...
export default ConditionContenidoDelMensaje;
