...
//import icon
import { IconMessage2, IconChevronDown } from '@tabler/icons';
//asset
...
export default function RecipeReviewCard() {
  ...
  return (
    <Card sx={{ border: `1px solid ${theme.palette.grey[300]}`, maxWidth: expanded ? 1000 : 365, minWidth: 365 }}>
      <CardHeader
        avatar={
          <Avatar sx={{ bgcolor: green[500] }} aria-label="recipe">
            <IconMessage2 style={{ color: 'white' }} />
          </Avatar>
        }
        action={
          <>
